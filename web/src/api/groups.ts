  ...
  rows: Array.isArray(data.rows)
    ? data.rows.map(
        (meeting): GroupMeetingPublic => ({
          ...
          endCheckinHoursBefore: meeting.endCheckinHoursBefore ?? 0,
          checkinClosesAt: meeting.checkinClosesAt,
          isCheckinClosedByCuttoff: meeting.isCheckinClosedByCuttoff ?? false,
          checkinPeriodMessage: meeting.checkinPeriodMessage,
...
const normalizeMemberMeetingFeedItem = (
  ...
  endCheckinHoursBefore: item.endCheckinHoursBefore ?? 0,
  checkinClosesAt: item.checkinClosesAt,
  isCheckinClosedByCuttoff: item.isCheckinClosedByCuttoff ?? false,
  checkinPeriodMessage: item.checkinPeriodMessage,
...
const normalizeMeetingDetailResponse = (
  ...
  isCheckinClosedByCuttoff: data.isCheckinClosedByCuttoff ?? false,
  checkinPeriodMessage: data.checkinPeriodMessage,
